			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<header class="entry-header">
					...
					<nav role="navigation" id="image-navigation" class="navigation-image">
						<div class="previous"><?php previous_image_link( false, __( '<span class="meta-nav">&larr;</span> Previous', '_sf' ) ); ?></div>
					...
					<div class="entry-attachment">
						<div class="attachment">
							...
							<a href="<?php echo $next_attachment_url; ?>" title="<?php the_title_attribute(); ?>" rel="attachment"><?php
								$attachment_sfize = apply_filters( '_sf_attachment_sfize', array( 1200, 1200 ) ); // Filterable image size.
								echo wp_get_attachment_image( $post->ID, $attachment_sfize );
							?></a>
						</div><!-- .attachment -->
