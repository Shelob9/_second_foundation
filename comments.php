 ...
 * handled by a callback to _sf_comment() which is
...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="comment-list">
			<?php
				 ...
				 * See _sf_comment() in inc/template-tags.php for more.
				 */
	...
	<?php
		...
		if ( ! comments_open() && '0' != get_comments_number() && post_type_sfupports( get_post_type(), 'comments' ) ) :
	?>
